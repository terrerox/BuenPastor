...
<li><img src="IMG/bank.png" alt=""></li>
<li><img src="IMG/bank.png" alt=""></li>
<li><img src="IMG/bank.png" alt=""></li>
<li><img src="IMG/bank.png" alt=""></li>
<li><img src="IMG/bank.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/aut.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>Un cajero automático es una máquina expendedora usada para extraer dinero utilizando una tarjeta de plástico con banda magnética o un chip (por ejemplo, tarjeta de débito o tarjeta de crédito), sin necesidad de presencia del personal del banco.</p><br>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/FDIC_Module1Sp_PG.pdf" class="btn btn-primary  mb-4">Decargar</a>
