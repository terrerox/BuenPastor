...
<li><img src="IMG/beauty.png" alt=""></li>
<li><img src="IMG/beauty.png" alt=""></li>
<li><img src="IMG/beauty.png" alt=""></li>
<li><img src="IMG/beauty.png" alt=""></li>
<li><img src="IMG/beauty.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/4.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>Un estilista es un profesional que se dedica a asesorar sobre la vestimenta, el peinado y, en general, la imagen y estética de los clientes, normalmente tomando como guía la moda o tendencias del momento.</p><br>
     <p><strong>Sabados</strong> de 8:30AM a 10:00AM</p>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/Manual_de_Estilista_Unisex_Luís_Barrios_M.pdf" class="btn btn-primary  mb-4">Decargar</a>
