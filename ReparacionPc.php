...
<li><img src="IMG/pcfix.png" alt=""></li>
<li><img src="IMG/pcfix.png" alt=""></li>
<li><img src="IMG/pcfix.png" alt=""></li>
<li><img src="IMG/pcfix.png" alt=""></li>
<li><img src="IMG/pcfix.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/pc.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>Es una máquina digital que ejecuta comandos para convertirlos en datos convenientes y útiles que posteriormente se envían a las unidades de salida. Un computador está formado físicamente por numerosos circuitos integrados y muchos componentes de apoyo, extensión y accesorios, que en conjunto pueden ejecutar tareas diversas con suma rapidez y bajo el control de un programa (software).</p><br>
     <p><strong>Sabados</strong> de 10:00AM a 11:30PM</p>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/Curso-De-Reparacion-De-Ordenadores.pdf" class="btn btn-primary  mb-4">Decargar</a>
