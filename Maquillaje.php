...
<li><img src="IMG/facial.png" alt=""></li>
<li><img src="IMG/facial.png" alt=""></li>
<li><img src="IMG/facial.png" alt=""></li>
<li><img src="IMG/facial.png" alt=""></li>
<li><img src="IMG/facial.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/2.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>El maquillaje es la práctica de decorar la piel y otras partes visibles del cuerpo para resaltarlas.1​También se define como maquillaje todo producto usado para decorar o arreglar rasgos faciales o corporales de una persona; este se compone de diversos elementos con funciones determinadas para cada parte (ojos, labios, cejas, pestañas, Entre Otros).Recibe su nombre en honor a Venus, la diosa romana del amor.</p><br>
     <p><strong>Sabados</strong> de 11:30AM a 1:00PM</p>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/primeras-paginas-primeras-paginas-guia-practica-de-maquillaje-es.pdf" class="btn btn-primary  mb-4">Decargar</a>
