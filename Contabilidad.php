...
<li><img src="IMG/calculadora.png" alt=""></li>
<li><img src="IMG/calculadora.png" alt=""></li>
<li><img src="IMG/calculadora.png" alt=""></li>
<li><img src="IMG/calculadora.png" alt=""></li>
<li><img src="IMG/calculadora.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/contable.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>La contabilidad es una disciplina que se encarga de estudiar, medir y analizar el patrimonio y la situación económico financiera de una empresa u organización, con el fin de facilitar la toma de decisiones en el seno de la misma y el control externo, presentando la información, previamente registrada, de manera sistemática y útil para las distintas partes interesadas.</p><br>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/Curso-Practico-Operaciones-Bancarias-Caja (1).pdf" class="btn btn-primary  mb-4">Decargar</a>
