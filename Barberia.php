...
<li><img src="IMG/barber.png" alt=""></li>
<li><img src="IMG/barber.png" alt=""></li>
<li><img src="IMG/barber.png" alt=""></li>
<li><img src="IMG/barber.png" alt=""></li>
<li><img src="IMG/barber.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/pela.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>Una peluquería o barbería es un local donde se ofrecen varios servicios estéticos, principalmente el corte de pelo, pero también suelen realizarse otros como afeitado, depilado, manicura, pedicura, etc. Cuando se trata de muchos servicios diferentes suele llamarse salón de belleza.</p><br>
     <p><strong>Sabados</strong> de 11:00AM a 1:00PM</p>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/cursos_peluqueria.pdf" class="btn btn-primary  mb-4">Decargar</a>
