...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/3.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>La reparación es, en sentido amplio, la restitución de algo que está dañado a su estado original. Más específicamente, puede referirse a los siguientes conceptos.</p><br>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/Curso_Reparacion_de_Celulares_Curso_Repa.pdf" class="btn btn-primary  mb-4">Decargar</a>
