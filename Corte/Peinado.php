  ...
  <div class="collapse navbar-collapse mt-3" id="navbarNav">
    <ul class="navbar-nav ml-auto mt-2">
      <li class="nav-item active mx-5">
        <a class="nav-link text-center" href="#down"><strong>PDF</strong> </a>
      </li>
...
<li><img src="IMG/corte.png" alt=""></li>
<li><img src="IMG/corte.png" alt=""></li>
<li><img src="IMG/corte.png" alt=""></li>
<li><img src="IMG/corte.png" alt=""></li>
<li><img src="IMG/corte.png" alt=""></li>
...
<div class="container">
  <div class="row">
    <div class="col-md-6">
<img src="cursos/peinado.jpg" width="70%" class="rounded">
    </div>
   <div class="col-md-6 text-center">
     <p>El peinado o estilo del cabello es la forma de cortarse o arreglarse el cabello. Los seres humanos de muchas culturas cortan su cabello, en vez de dejarlo crecer naturalmente.</p><br>
     <p><strong>Sabados</strong> de 8:30AM a 10:00PM</p>
...
<div class="container text-center">
  <div class="row">
    ...
    <h2 class="mt-4">
      ...
      <a href="pdf/Curso-Peinados-Acabados-Recogidos.pdf" class="btn btn-primary  mb-4">Decargar</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h5>Utilizamos cookies propias y de terceros para mejorar nuestros servicios. Si continúa navegando, consideramos que acepta su uso. Puede obtener más información, o bien conocer cómo cambiar la configuración, en nuestra política de cookies.</h5>
      </div>
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Editar perfil  
